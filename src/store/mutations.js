...
export default {
  ...
  addCardToStack (state, payload) {
    console.log(payload.card.cardImg)
    if (payload.card.cardImg === '/static/cardImg/RepetitionX.png' || payload.card.cardImg === '/static/cardImg/Repetition2.png' || payload.card.cardImg === '/static/cardImg/Repetition3.png' || payload.card.cardImg === '/static/cardImg/Repetition4.png') {
      state.players[0].repeatPlayed = true
      state.players[1].repeatPlayed = true
    }
    if (payload.card.cardImg === '/static/cardImg/Group2.png' || payload.card.cardImg === '/static/cardImg/Group3.png' || payload.card.cardImg === '/static/cardImg/Group4.png' || payload.card.cardImg === '/static/cardImg/Group5.png' || payload.card.cardImg === '/static/cardImg/Group6.png') {
      state.players[0].groupPlayed = true
      state.players[1].groupPlayed = true
    }
    if (payload.card.cardImg === '/static/cardImg/Variable3.png' || payload.card.cardImg === '/static/cardImg/Variable4.png' || payload.card.cardImg === '/static/cardImg/Variable5.png' || payload.card.cardImg === '/static/cardImg/Variable6.png') {
      state.players[0].varPlayed = true
      state.players[1].varPlayed = true
    }
